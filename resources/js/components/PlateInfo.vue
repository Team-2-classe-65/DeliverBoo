      ...
      <div class="container my-container">
        ...
        <div class="container">
          <div class="rounded mx-auto d-block">
            <div v-for="i in [currentIndex]" :key="i">
              <img class="img-fluid rounded mx-auto d-block" :src="currentImg" />
            </div>
          </div>
        ...
        <div class="container pt-3">
          <div class="rounded mx-auto d-block bg-black">
            <div class="card">
              <div class="card-img" v-for="ind in [currentIndexChef]" :key="ind">
                <img class="img-fluid px-3 pt-5" :src="currentChef" />
                <div class="card-body" v-for="index in [currentIndexStory]" :key="index">
                  <p class="bg-black card-text text-white padding-x py-3">{{currentStory}}</p>
                </div>
              </div>
